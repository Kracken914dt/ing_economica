                ...
                child: Column(
                  children: [
                    ...
                    _buildDropdown(
                      ...
                      items: ['Valor Presente', 'Valor Primera Cuota'],
                    ...
                    _buildTextField(
                      ...
                      label: (_selectedOption2 == "Valor Presente")
                          ? "Valor Primera Cuota"
                          : "Valor Presente",
                    ...
                    const SizedBox(height: 24),
                    if (_presentAmount != null) _buildResultCard(),
                  ],
                ),
              ),
            ),
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                _calculator.formatNumber(_presentAmount!),
                style: TextStyle(
                  fontSize: 30,
