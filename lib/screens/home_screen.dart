...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return WillPopScope(
      ...
      child: Scaffold(
        backgroundColor: const Color.fromARGB(255, 194, 247, 172),
        body: IndexedStack(
        ...
        bottomNavigationBar: BottomNavigationBar(
          ...
          unselectedItemColor: const Color.fromARGB(246, 85, 85, 85),
          backgroundColor: const Color.fromARGB(255, 84, 249, 119),
          onTap: _onItemTapped,
